...
<html lang="en">
    <head>
      ...
      <script src="scripts.js"></script>
        ...
        <!-- Page canonical URL -->
        <link rel="canonical" href="http://167.71.140.97/">

        <!-- Icons -->
        <link rel="icon" href="http://167.71.140.97/media-uploads/IMP_lines.png/" type="image/x-icon"> 
        <link rel="shortcut icon" href="http://167.71.140.97/media-uploads/IMP_lines.png/" type="image/x-icon">
        <link rel="apple-touch-icon" sizes="192x192" href="http://167.71.140.97/media-uploads/IMP_lines.png/">
        <link rel="icon" type="image/png" sizes="32x32" href="http://167.71.140.97/media-uploads/IMP_lines.png/">
        <link rel="icon" type="image/png" sizes="16x16" href="http://167.71.140.97/media-uploads/IMP_lines.png/">

        <!-- Facebook Open Graph -->
        <meta property="og:title" content="IMPF1 - Professional Ro-Racing">
        <meta property="og:type" content="IMPF1">
        <meta property="og:url" content="http://167.71.140.97/">
        <meta property="og:image" content="http://167.71.140.97/media-uploads/IMPLOGONEW.png">
        ...
        <meta name="twitter:url" content="http://167.71.140.97/">
        ...
        <meta name="twitter:image" content="http://167.71.140.97/media-uploads/IMPLOGONEW.png">
